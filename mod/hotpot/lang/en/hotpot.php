...
// roles strings
$string['hotpot:attempt'] = 'Attempt quizzes';
$string['hotpot:deleteattempt'] = 'Delete quiz attempts';
$string['hotpot:grade'] = 'Grade quizzes manually';
$string['hotpot:ignoretimelimits'] = 'Ignores time limit on quizzes';
$string['hotpot:manage'] = 'Manage quizzes';
$string['hotpot:preview'] = 'Preview quizzes';
$string['hotpot:review'] = 'Review quiz attempts';
$string['hotpot:view'] = 'View quiz information';
$string['hotpot:viewreport'] = 'View quiz reports';
