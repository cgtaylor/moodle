...
// get parent class
require_once($CFG->dirroot.'/mod/hotpot/attempt/hp/6/jmix/renderer.php');

class mod_hotpot_attempt_hp_6_jmix_html_renderer extends mod_hotpot_attempt_hp_6_jmix_renderer {
