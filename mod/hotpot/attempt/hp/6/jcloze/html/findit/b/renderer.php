...
class mod_hotpot_attempt_hp_6_jcloze_html_findit_b_renderer extends mod_hotpot_attempt_hp_6_jcloze_html_findit_renderer {
    ...
    public static function sourcetypes()  {
        return array('hp_6_jcloze_html_findit_b');
    }
