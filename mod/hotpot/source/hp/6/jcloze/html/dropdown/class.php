 ...
 * Source type: hp_6_jcloze_html_dropdown
 *
 * @package   mod-hotpot
...
// get parent class
require_once($CFG->dirroot.'/mod/hotpot/source/hp/6/jcloze/html/class.php');

class hotpot_source_hp_6_jcloze_html_dropdown extends hotpot_source_hp_6_jcloze_html {
    ...
    public static function is_quizfile($sourcefile)  {
        ...
        if (! strpos($content, 'this.GapLocked = false;')) {
