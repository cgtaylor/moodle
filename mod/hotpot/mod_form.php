    ...
    function add_activity_list($type)  {
        ...
        $optgroups = array(
            ...
            get_string($type=='entry' ? 'previous' : 'next') => array(
                ...
                hotpot::ACTIVITY_COURSE_QUIZPORT  => get_string($type.'hotpotcourse', 'hotpot'),
                hotpot::ACTIVITY_SECTION_QUIZPORT => get_string($type.'hotpotsection', 'hotpot')
            )
        );
        ...
        if ($type=='entry') {
            ...
            $mform->setDefault($type.'cm', get_user_preferences('hotpot_'.$type.'cm', hotpot::ACTIVITY_SECTION_QUIZPORT));
