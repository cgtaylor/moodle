...
function get_mimetypes_array() {
	...
	'notebook' => array ('type'=>'application/notebook','icon' => 'notebook'),
	  ...
	  'pub'  => array ('type'=>'application/vnd.ms-publisher', 'icon'=>'pub'),
	  'pubx' => array ('type'=>'application/vnd.ms-publisher', 'icon'=>'pub'),
